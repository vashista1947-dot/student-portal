          ...
          <div className="form-group" style={{ marginBottom: '22px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', marginTop: '6px' }}>
              {coursesList.map(course => (
                <label key={course} style={{ display: 'flex', alignItems: 'center', gap: '6px', background: formData.allowedDegrees.includes(course) ? 'rgba(204,120,92,0.08)' : 'var(--bg-input)', border: formData.allowedDegrees.includes(course) ? '1px solid var(--accent-primary)' : '1px solid var(--border-color)', padding: '8px 14px', borderRadius: 'var(--radius-sm)', cursor: 'pointer', transition: 'all var(--transition-fast)', fontSize: '0.8rem', fontWeight: 600 }}>
            ...
            <div className="form-group animate-slide-down" style={{ marginBottom: '18px' }}>
              ...
              <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginTop: '6px' }}>
                {btechBranches.map(branch => (
                  <label key={branch} style={{ display: 'flex', alignItems: 'center', gap: '6px', background: formData.allowedBranches.includes(branch) ? 'rgba(204,120,92,0.08)' : 'var(--bg-input)', border: formData.allowedBranches.includes(branch) ? '1px solid var(--accent-primary)' : '1px solid var(--border-color)', padding: '6px 14px', borderRadius: 'var(--radius-sm)', cursor: 'pointer', transition: 'all var(--transition-fast)', fontSize: '0.8rem', fontWeight: 600 }}>
